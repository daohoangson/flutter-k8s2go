...
class RbacAuthorizationApi {
    ...
    RbacAuthorizationApi(this._dio, this._serializers);

        /// 
        ///
        /// get information of a group
        Future<Response<IoK8sApimachineryPkgApisMetaV1APIGroup>>getRbacAuthorizationAPIGroup({ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/apis/rbac.authorization.k8s.io/";
