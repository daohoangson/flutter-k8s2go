...
class ApiregistrationApi {
    ...
    ApiregistrationApi(this._dio, this._serializers);

        /// 
        ///
        /// get information of a group
        Future<Response<IoK8sApimachineryPkgApisMetaV1APIGroup>>getApiregistrationAPIGroup({ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/apis/apiregistration.k8s.io/";
