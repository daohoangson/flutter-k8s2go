...
part 'io_k8s_api_policy_v1beta1_pod_security_policy_spec.g.dart';

abstract class IoK8sApiPolicyV1beta1PodSecurityPolicySpec implements Built<IoK8sApiPolicyV1beta1PodSecurityPolicySpec, IoK8sApiPolicyV1beta1PodSecurityPolicySpecBuilder> {
    ...
    BuiltList<IoK8sApiPolicyV1beta1AllowedFlexVolume> get allowedFlexVolumes;
    /* allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used. */
        @nullable
    @BuiltValueField(wireName: r'allowedHostPaths')
    BuiltList<IoK8sApiPolicyV1beta1AllowedHostPath> get allowedHostPaths;
    ...
    IoK8sApiPolicyV1beta1FSGroupStrategyOptions get fsGroup;
    ...
    BuiltList<IoK8sApiPolicyV1beta1HostPortRange> get hostPorts;
    ...
    IoK8sApiPolicyV1beta1RunAsGroupStrategyOptions get runAsGroup;
    
        @nullable
    @BuiltValueField(wireName: r'runAsUser')
    IoK8sApiPolicyV1beta1RunAsUserStrategyOptions get runAsUser;
    
        @nullable
    @BuiltValueField(wireName: r'seLinux')
    IoK8sApiPolicyV1beta1SELinuxStrategyOptions get seLinux;
    
        @nullable
    @BuiltValueField(wireName: r'supplementalGroups')
    IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions get supplementalGroups;
    ...
    IoK8sApiPolicyV1beta1PodSecurityPolicySpec._();

    factory IoK8sApiPolicyV1beta1PodSecurityPolicySpec([updates(IoK8sApiPolicyV1beta1PodSecurityPolicySpecBuilder b)]) = _$IoK8sApiPolicyV1beta1PodSecurityPolicySpec;
    static Serializer<IoK8sApiPolicyV1beta1PodSecurityPolicySpec> get serializer => _$ioK8sApiPolicyV1beta1PodSecurityPolicySpecSerializer;
