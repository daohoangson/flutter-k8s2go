...
class ApiextensionsApi {
    ...
    ApiextensionsApi(this._dio, this._serializers);

        /// 
        ///
        /// get information of a group
        Future<Response<IoK8sApimachineryPkgApisMetaV1APIGroup>>getApiextensionsAPIGroup({ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/apis/apiextensions.k8s.io/";
