...
class AdmissionregistrationApi {
    ...
    AdmissionregistrationApi(this._dio, this._serializers);

        /// 
        ///
        /// get information of a group
        Future<Response<IoK8sApimachineryPkgApisMetaV1APIGroup>>getAdmissionregistrationAPIGroup({ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/apis/admissionregistration.k8s.io/";
