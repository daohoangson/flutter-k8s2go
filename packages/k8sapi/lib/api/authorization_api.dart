...
class AuthorizationApi {
    ...
    AuthorizationApi(this._dio, this._serializers);

        /// 
        ///
        /// get information of a group
        Future<Response<IoK8sApimachineryPkgApisMetaV1APIGroup>>getAuthorizationAPIGroup({ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/apis/authorization.k8s.io/";
