...
class ExtensionsApi {
    ...
    ExtensionsApi(this._dio, this._serializers);

        /// 
        ///
        /// get information of a group
        Future<Response<IoK8sApimachineryPkgApisMetaV1APIGroup>>getExtensionsAPIGroup({ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/apis/extensions/";
