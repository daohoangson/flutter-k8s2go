...
class EventsApi {
    ...
    EventsApi(this._dio, this._serializers);
        ...
        Future<Response<IoK8sApimachineryPkgApisMetaV1APIGroup>>getEventsAPIGroup({ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/apis/events.k8s.io/";
