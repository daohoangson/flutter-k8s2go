...
class AutoscalingApi {
    ...
    AutoscalingApi(this._dio, this._serializers);

        /// 
        ///
        /// get information of a group
        Future<Response<IoK8sApimachineryPkgApisMetaV1APIGroup>>getAutoscalingAPIGroup({ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/apis/autoscaling/";
